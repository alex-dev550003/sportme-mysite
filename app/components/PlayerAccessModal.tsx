...
export default function PlayerAccessModal({ onClose, playerWebUrl, playerPlayStoreUrl }: Props) {
  ...
  return (
    <div className="fixed inset-0 isolate z-[999] flex items-center justify-center bg-black/72 px-4 py-6" onClick={onClose} role="dialog" aria-modal="true">
      <div
        className="manager-access-modal relative z-[1000] w-full max-w-3xl rounded-[28px] border border-[#d8d1bf] bg-[radial-gradient(circle_at_top_right,_#ffffff_0%,_#f3f4f6_62%,_#eceff3_100%)] p-5 shadow-[0_30px_80px_-38px_rgba(32,33,31,0.9)]"
